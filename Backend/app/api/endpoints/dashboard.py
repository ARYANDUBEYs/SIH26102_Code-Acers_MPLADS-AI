...
async def get_dashboard_summary(
    ...
    for p in in_scope:
        ...
        image_risk = 92.0 if record.project_id == "MPLAD-26-1021" else (85.0 if record.project_id == "MPLAD-26-3314" else 0.0)
        vendor_risk = 80.0 if record.contractor_id == "VEN-8821" else 15.0
        assessments.append(anomaly_scorer_service.calculate_project_risk(record, image_risk, vendor_risk))
