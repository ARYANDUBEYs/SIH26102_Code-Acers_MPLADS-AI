...
export const GovFooter = () => {
  return (
    <footer id="contact" className="relative z-30 w-full bg-[#130624] text-slate-300 border-t border-purple-950/80 scroll-mt-10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-xs">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-2 pt-1">
            <span className="px-2 py-0.5 bg-purple-950/60 text-purple-300 border border-purple-700/50 rounded text-[10px] font-mono">
              Viksit Bharat @ 2047
            </span>
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2 text-slate-400 text-[11px]">
            <div className="flex items-start gap-2">
              <Phone className="w-3.5 h-3.5 text-purple-400 mt-0.5 shrink-0" />
              <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="mailto:cna-mplads@mospi.gov.in" className="text-purple-400 hover:underline">
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-1.5 text-slate-400 text-[11px]">
            <li>
              <a href="https://www.mplads.mospi.gov.in" target="_blank" rel="noreferrer" className="hover:text-purple-400 flex items-center gap-1">
            ...
            <li>
              <Link to="/public" className="hover:text-purple-400">Citizen Transparency Portal</Link>
            </li>
            <li>
              <Link to="/login" className="hover:text-purple-400">Officer Secure Access</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2 pt-1">
            <div className="p-2 bg-slate-900/80 border border-slate-800 rounded-lg flex items-center gap-3">
              <div className="w-7 h-7 bg-purple-600 rounded-md flex items-center justify-center font-bold text-white text-xs">
                eS
              </div>
      ...
      <div className="border-t border-purple-950/80 bg-[#0c0417] py-4 px-4 sm:px-6 lg:px-8">
