      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-1">
        ...
        <div className="flex items-center gap-3 shrink-0 self-end sm:self-center">
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2 bg-white border border-slate-200 rounded-xl text-xs font-semibold text-slate-700 hover:text-slate-900 shadow-2xs hover:border-slate-300 transition cursor-pointer"
          >
      ...
      <div className="bg-white rounded-2xl border border-slate-200/80 p-4 shadow-2xs flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="relative min-w-[260px]">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-slate-50 rounded-xl border border-slate-200 text-xs text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition"
          />
        </div>
      </div>
              ...
              <div className="p-5 sm:p-6 space-y-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-center">
                  ...
                  <div className="lg:col-span-7 space-y-1.5">
                    ...
                    <div className={`p-2.5 rounded-xl text-xs flex items-center gap-2.5 mt-2 ${
                      isAuditReq
                  ...
                  <div className="lg:col-span-5 bg-slate-50/70 border border-slate-100 rounded-xl p-3.5 space-y-2 text-xs">
                    ...
                    {isApproved ? (
                      ...
                      <>
                        <button
                          ...
                          className="px-3.5 py-1.5 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-700 text-xs font-bold border border-rose-200 flex items-center gap-1.5 transition cursor-pointer"
                        >
                      ...
                      <>
                        <button
                          type="button"
                          onClick={() => handleOpenApproveModal(proposal)}
                          className="px-4 py-2 rounded-xl bg-[#16A34A] hover:bg-[#15803D] active:scale-[0.98] text-white text-xs font-bold transition shadow-xs flex items-center gap-1.5 cursor-pointer"
                        >
          ...
          <div className="space-y-4 text-xs">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-2.5 rounded-xl border border-slate-200 bg-white text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500/20 text-xs font-medium"
              />
            </div>
            ...
            <div className="flex items-center justify-end gap-2.5 pt-2 border-t border-slate-100">
              <button
                ...
                className="px-4 py-2 rounded-xl border border-slate-200 text-slate-700 hover:bg-slate-50 font-semibold text-xs transition cursor-pointer"
              >
                Cancel
              </button>
              <button
