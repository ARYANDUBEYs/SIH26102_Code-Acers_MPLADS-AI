      ...
      <header className="sticky top-0 z-40 bg-gov-surface border-b border-gov-border shadow-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="font-extrabold text-base tracking-tight text-gov-navy">
                  MPLADS <span className="text-gov-saffron font-bold">PROJECT SEARCH</span>
                </span>
              ...
              <p className="text-[10px] text-gov-muted font-medium">Public Transparency Registry • Constituency Database</p>
            </div>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-5 text-xs font-semibold text-gov-muted">
            ...
            <Link to="/public/search" className="text-gov-navy font-bold border-b-2 border-gov-navy pb-0.5">Search Works</Link>
          </nav>
