  ...
  return (
    <div className="min-h-screen bg-gov-darkest flex flex-col justify-between text-slate-100 selection:bg-blue-600">
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-12 bg-slate-900 border border-slate-800 rounded-lg shadow-2xl overflow-hidden">
          {/* Left Hero / Info Pane */}
          <div className="lg:col-span-6 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-8 sm:p-12 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-slate-800 relative">
            <div>
              <Link to="/" className="inline-flex items-center gap-3 group mb-8">
                <div className="w-10 h-10 rounded-md bg-blue-600 p-0.5 flex items-center justify-center">
              ...
              <div className="space-y-3">
                <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs font-semibold">
            ...
            <div className="mt-8 pt-6 border-t border-slate-800 flex items-center justify-between text-[11px] text-slate-500 font-mono">
          ...
          {/* Right Form Card */}
          <div className="lg:col-span-6 p-8 sm:p-12 flex flex-col justify-center bg-slate-900/95">
            {children}
          </div>
        </div>
      </div>

      <div className="p-4 text-center text-xs text-slate-400 font-mono border-t border-slate-900 bg-slate-950">
